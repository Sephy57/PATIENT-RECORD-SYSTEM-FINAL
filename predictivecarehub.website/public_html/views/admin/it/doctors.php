...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <div class="relative w-full flex flex-col h-screen overflow-y-hidden relative">
        ...
        <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6 mb-24">
                <h1 class="text-3xl text-black pb-6">Doctors</h1>

                <div class="w-full mt-6">
                    <p class="text-xl pb-3 flex items-center">
                        <i class="fas fa-list mr-3"></i> Doctor Lists
                    </p>
                    <div class="container w-full md:w-4/5 xl:w-3/5" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                        ...
                        <div id='recipients' class="p-8 mt-6 lg:mt-0 rounded shadow bg-white w-full">
                            ...
                            <table id="doctors" class="stripe hover reload_table" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                                <thead>
                                    <tr>
                                        <th data-priority="2" class="text-left">Doctor ID</th>
                                        ...
                                        <th data-priority="6" class="text-left">Department</th>
                                        <th data-priority="1" class="text-left">Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    $sql = "SELECT doctor_id, username, firstname, lastname, department FROM doctors";
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        <td class='flex items-center flex-wrap sm:flex-nowrap gap-6' >
                                            <button class='group edit_doctor' title='Edit' data-id='" . e($row['doctor_id']) . "' data-username='" . e($row['username']) . "' data-firstname='" . e($row['firstname']) . "' data-lastname='" . e($row['lastname']) . "' data-department='" . e($row['department']) . "'>
                                            ...
                                            <button class='group delete_doctor' data-delete-type='delete_doctor' data-delete-id=" . e($row['doctor_id']) . " title='Delete'>
    ...
    <?php include 'partials/edit_doctor_modal.php'; ?>
