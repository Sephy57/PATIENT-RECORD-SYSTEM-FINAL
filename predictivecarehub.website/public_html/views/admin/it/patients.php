            ...
            <main class="w-full flex-grow p-6 mb-24">
                ...
                <div class="w-full mt-6">
                    <p class="text-xl pb-3 flex items-center">
                        <i class="fas fa-list mr-3"></i> Patient Lists
                    </p>
                            ...
                            <table id="patients" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-priority="3" class="text-left">Mobile no.</th>
                                        <th data-priority="4" class="text-left">Email</th>
                                        <th data-priority="5" class="text-left">First name</th>
                                        <th data-priority="6" class="text-left">Last Name</th>
                                        <th data-priority="7" class="text-left">Status</th>
                                        <th data-priority="1" class="text-left">Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    $sql = "SELECT patient_id, number, email, firstname, lastname, account_verified FROM patients";
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        <td>" . e($row['lastname']) . "</td>";
                                            ...
                                            echo "<td>
                                            <button class='group delete_patient' data-delete-type='delete_patient' data-delete-id=" . e($row['patient_id']) . " title='Delete'>
