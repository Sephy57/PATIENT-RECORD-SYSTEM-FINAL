...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <div class="relative w-full flex flex-col h-screen overflow-y-hidden relative">
        ...
        <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6 mb-24">
                <h1 class="text-3xl text-black pb-6">Services</h1>
                <button id="add_services_btn" class="w-auto px-5 bg-gray-950 text-white hover:bg-gray-900 text-gray-900 font-semibold py-2 mt-5 rounded-br-lg rounded-bl-lg rounded-tr-lg shadow-lg hover:shadow-xl flex items-center justify-center">
                    <i class="fas fa-plus mr-3"></i> Add Services
                </button>
                <div class="w-full mt-6">
                    <p class="text-xl pb-3 flex items-center">
                        <i class="fas fa-list mr-3"></i> List of Services
                    </p>
                                ...
                                <tbody>
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        <td>" . e($row['description']) . "</td>";
                                            ...
                                            <button class='group edit_services' data-id='" . e($row['service_id']) . "' data-title='" . e($row['service_name']) . "' data-description='" . e($row['description']) . "' title='Edit'>
                                            ...
                                            <button class='group delete_service' data-delete-type='delete_service' data-delete-id=" . e($row['service_id']) . " title='Delete'>
    ...
    <?php include 'partials/add_services_modal.php'; ?>
    <?php include 'partials/delete_modal.php'; ?>
    <?php include 'partials/loading.php'; ?>
    <?php include 'partials/edit_services_modal.php'; ?>
