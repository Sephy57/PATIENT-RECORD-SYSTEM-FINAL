                    ...
                    <div class="container w-full lg:w-4/5 xl:w-3/5" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                        ...
                        <div class="p-8 mt-6 lg:mt-0 rounded shadow bg-white w-full">
                            ...
                            <table id="patients" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                                ...
                                <tbody>
                                    <?php
                                    $sql = "SELECT id, patient_id, patient_name, request_type, doctor_name, doctor_id, document, createdAt FROM medical_records WHERE archived = 0 AND approved = 1 AND uploaded = 1";
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            $file_name = $row['document'] == null ? "" : $row['request_type'];
                                            $style = $row['document'] == null ? "hidden" : "block";
                                        ...
                                        <td>" . e($row['createdAt']) . "</td>";
                                            ...
                                            <button class='group uupload_medical' title='Upload' data-id='" . e($row['id'])  . "' data-file-name='" . e($file_name)  . "' data-style='" . e($style)  . "'>
                                                <i class='fas fa-solid fa-upload text-blue-600 mr-3'></i> Update
                                            </button>
                                            <button class='group archive_medical' data-delete-type='archive_medical' data-delete-id='" . e($row['id']) . "' title='Archive'>
                                                <i class='fas fa-file-archive text-orange-600 group-hover:text-orange-500 mr-3'></i>Archive
                                            </button>
