    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden relative">
        ...
        <div class="w-full overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6 mb-24">
                ...
                ?>
                        ...
                        <div class="w-full lg:w-1/2 pl-0 lg:pl-1 mt-2 lg:mt-0">
                            <div class="p-6 bg-white">
                                ...
                                <p class="text-slate-500 font-italic">Medical Record Manager</p>
                            </div>
                        </div>
                ...
                <!-- 4 NEW ADDED PENDING REQUESTS -->
                <div class="w-full mt-12">
                    <p class="text-xl pb-3 flex items-center">
                        <i class="fas fa-list mr-3"></i> New Requests
                    </p>
                        ...
                        <table class="min-w-full bg-white">
                            <thead class="bg-gray-800 text-white">
                                <tr>
                                    ...
                                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Request Date</th>
                                </tr>
                            </thead>
                            <tbody class="text-gray-700">
                                <?php
                                $sql = "SELECT patient_id, patient_name, request_type, doctor_name, createdAt FROM medical_records WHERE archived = 0 AND approved = 1 AND seen = 2 AND uploaded=0 ORDER BY createdAt DESC";
                                $result = mysqli_query($conn, $sql);
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    ...
                                    echo "<tr class='bg-gray-200'><td class='text-left py-3 px-4 text-gray-950' colspan='6'>No medical request available.</td></tr>";
                                }
                                ?>
                            </tbody>
                        </table>
