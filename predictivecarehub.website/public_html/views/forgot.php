...
<body class="bg-gray-100 font-family-karla">
    ...
    <div class="flex justify-center items-center flex-col w-full my-12 pl-0 lg:pl-2 z-[999] header-clip">
        ...
        <div class="leading-loose w-[90%] md:w-[80%] lg:w-[50%] xl:w-[25%]">
            ...
            <form class="p-10 bg-white rounded-2xl shadow-xl border border-gray-100" id="forgot_password">
                <div class="mt-2">
                    <label class=" block text-sm text-gray-600 mb-2 text-center" for="email">Please provide the email address that you used when you register for your account.</label>
                    <span class=" block text-sm text-gray-600 mb-4 text-center">If you forgot your email, please contact us at <a href="mailto:predictivecarehub@gmail.com" class="text-blue-500 hover:text-blue-600">predictivecarehub@gmail.com</a>.</span>
                ...
                <div class="mt-2">
                    <span class="hidden text-sm text-red-500 fgt">Email is not registered.</span>
                </div>

                <div class="mt-4 text-center">
                    <span class=" block text-sm text-green-600 mb-2">We will send you a link for changing your password account.</span>
                </div>
