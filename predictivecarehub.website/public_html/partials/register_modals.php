 ...
 <div class="w-full h-full">
     <div id="modal-bg" class="w-full h-full bg-[rgba(0,0,0,.6)] top-0 fixed hidden"></div>
     <div id="modal-box" class="w-[90%] lg:w-auto flex flex-col items-center gap-2 -translate-y-1/2 py-6 px-12 bg-white rounded top-1/2 left-1/2 -translate-x-1/2 fixed hidden">
         ...
         <span class="text-2xl font-medium">Success!</span>
         <p class="text-center mt-6">Your account has been created.</p>
         <p class="text-center">Please check your email for account verification.</p>
         <a class="mt-6 p-3 bg-sidebar rounded-full px-12 text-white text-center" href="/login">Back to login</a>
     </div>
 </div>
