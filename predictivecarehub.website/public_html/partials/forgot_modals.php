...
<div class="w-full h-full">
    <div id="forgot_modalbg" class="w-full h-full bg-[rgba(0,0,0,.6)] top-0 fixed hidden"></div>
    <div id="forgot_modal" class="w-[90%] lg:w-auto flex flex-col items-center gap-2 -translate-y-1/2 py-6 px-12 bg-white rounded top-1/2 left-1/2 -translate-x-1/2 fixed hidden">
